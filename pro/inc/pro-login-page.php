 ...
 */
add_filter( 'login_headerurl', 'flatblocks_pro_login_headerurl' );

function flatblocks_pro_login_headerurl( $url ) {
 ...
 */
add_filter( 'login_headertext', 'flatblocks_pro_login_headertitle' );

function flatblocks_pro_login_headertitle( $title ) {
 ...
 */
add_action( 'login_enqueue_scripts', 'flatblocks_pro_login_headerlogo' );

if ( has_site_icon() ) :
function flatblocks_pro_login_headerlogo() { ?>
    <style type="text/css">
        .login h1 a,
        #login h1 a {
