# Flat Blocks PRO: Package up the theme files, including plugin(s)

# First build all SCSS into CSS (standard and PRO CSS)
...
#sass --no-source-map --style=compressed scss:../assets/css ../pro/src/scss:../pro/assets/css
